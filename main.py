...
from MainFunc import first_insert, create_dict, create_api, get_token, create_api_filter, \
    pipeline_statuses_count, delete_all_files, update_token
...
first_insert(funcc=DataFunc.get_lead_status_changed, insert_funcc=update_leads_pipelines_status_date,
